...
return (new CustomEvent(event_name,(function (){var obj46663 = ({"detail":data});
return obj46663;
})()));
} else {
...
var f = (function (){var pred__46670 = cljs.core._EQ_;
var expr__46671 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__46670.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__46671))){
return ((function (pred__46670,expr__46671){
return (function (p1__46664_SHARP_){
return console.warn(p1__46664_SHARP_);
});
;})(pred__46670,expr__46671))
} else {
if(cljs.core.truth_(pred__46670.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__46671))){
return ((function (pred__46670,expr__46671){
return (function (p1__46665_SHARP_){
return console.debug(p1__46665_SHARP_);
});
;})(pred__46670,expr__46671))
} else {
if(cljs.core.truth_(pred__46670.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__46671))){
return ((function (pred__46670,expr__46671){
return (function (p1__46666_SHARP_){
return console.error(p1__46666_SHARP_);
});
;})(pred__46670,expr__46671))
} else {
return ((function (pred__46670,expr__46671){
return (function (p1__46667_SHARP_){
return console.log(p1__46667_SHARP_);
});
;})(pred__46670,expr__46671))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__46674){
...
var eval_fn = cljs.core.get.call(null,map__46675__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__46677_SHARP_);
});})(new_def))
);
...
return (function (p__46678){
var vec__46679 = p__46678;
var ky = cljs.core.nth.call(null,vec__46679,(0),null);
var v = cljs.core.nth.call(null,vec__46679,(1),null);
...
//# sourceMappingURL=utils.js.map?rel=1563208755220
