...
var G__40295 = devtools.prefs.pref.call(null,v);
v = G__40295;
continue;
} else {
return v;
...
}catch (e40298){var _e__38820__auto__ = e40298;
return false;
}})();
...
}catch (e40302){var _e__38820__auto__ = e40302;
return false;
}})();
...
}catch (e40304){var _e__38820__auto__ = e40304;
return false;
}}
}
});
...
var vec__40306 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__40306,(0),null);
var name = cljs.core.nth.call(null,vec__40306,(1),null);
...
return cljs.core.some.call(null,(function (p1__40309_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__40309_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1563208749204
