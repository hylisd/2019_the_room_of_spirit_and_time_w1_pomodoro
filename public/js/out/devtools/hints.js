...
var map__46568 = top_item;
var map__46568__$1 = (((((!((map__46568 == null))))?(((((map__46568.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__46568.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__46568):map__46568);
var file = cljs.core.get.call(null,map__46568__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__46568__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__46568__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e46567){var _e = e46567;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5733__auto___46570 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5733__auto___46570)){
var seen_errors_46571 = temp__5733__auto___46570;
if(cljs.core.truth_(seen_errors_46571.has(self))){
} else {
seen_errors_46571.add(self);

var temp__5735__auto___46572 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5735__auto___46572)){
var sense_46573 = temp__5735__auto___46572;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_46573)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1563208754976
