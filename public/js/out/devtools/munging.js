...
var o40190 = temp__5733__auto__;
var temp__5733__auto____$1 = (o40190["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o40191 = temp__5733__auto____$1;
return (o40191["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__38813__auto__ = f;
return (o__38813__auto__["toString"]).call(o__38813__auto__);
} else {
return "";
}
}catch (e40192){var _ = e40192;
return "";
}});
...
try{var o__38813__auto___40194 = t;
(o__38813__auto___40194["cljs$lang$ctorPrWriter"]).call(o__38813__auto___40194,t,writer);
}catch (e40193){var __40195 = e40193;
}
...
var char_code = (function (){var o__38813__auto__ = (new String(char$));
return (o__38813__auto__["charCodeAt"]).call(o__38813__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__38813__auto__ = String;
return (o__38813__auto__["fromCharCode"]).call(o__38813__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__40196 = num_code;
switch (G__40196) {
case (1):
return (185);
...
var o__38813__auto__ = String;
return (o__38813__auto__["fromCharCode"]).call(o__38813__auto__,superscript_code);
});
/**
...
}catch (e40198){var _e__38820__auto__ = e40198;
return false;
}})())){
...
var vec__40199 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__40199,(0),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var o40202 = temp__5733__auto__;
var temp__5733__auto____$1 = (o40202["dependencies_"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o40203 = temp__5733__auto____$1;
return (o40203["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__40206){
var vec__40207 = p__40206;
var ns_detector = cljs.core.nth.call(null,vec__40207,(0),null);
...
var G__40213 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__40214 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__40213;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq40204){
var G__40205 = cljs.core.first.call(null,seq40204);
var seq40204__$1 = cljs.core.next.call(null,seq40204);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__40205,seq40204__$1);
});
...
var vec__40218 = cljs.core.split_with.call(null,(function (p1__40217_SHARP_){
return cljs.core.not_EQ_.call(null,p1__40217_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__40218,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__40218,(1),null);
...
var vec__40224 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__40224,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__40224,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__40227 = cljs.core.rest.call(null,remaining_tokens);
var G__40228 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__40227;
name_tokens = G__40228;
continue;
} else {
...
var vec__40231 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__40231,(0),null);
var arity = cljs.core.nth.call(null,vec__40231,(1),null);
var vec__40234 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__40234,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__40234,(1),null);
var vec__40237 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__40237,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__40237,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__40237,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__40237,(3),null);
...
var vec__40243 = result;
var munged_ns = cljs.core.nth.call(null,vec__40243,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__40243,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__40243,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__40243,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__40243,(4),null);
var arity = cljs.core.nth.call(null,vec__40243,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__40247 = temp__5733__auto__;
var munged_name = cljs.core.nth.call(null,vec__40247,(0),null);
var args = cljs.core.nth.call(null,vec__40247,(1),null);
var vec__40250 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__40250,(0),null);
var name = cljs.core.nth.call(null,vec__40250,(1),null);
...
var G__40253 = (arity + (1));
var G__40254 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__40255){
var vec__40256 = p__40255;
var arity = cljs.core.nth.call(null,vec__40256,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__40256,(1),null);
...
return cljs.core.get.call(null,arities,p1__40259_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__40260_SHARP_);
...
var args__4736__auto__ = [];
var len__4730__auto___40267 = arguments.length;
var i__4731__auto___40268 = (0);
while(true){
if((i__4731__auto___40268 < len__4730__auto___40267)){
args__4736__auto__.push((arguments[i__4731__auto___40268]));

var G__40269 = (i__4731__auto___40268 + (1));
i__4731__auto___40268 = G__40269;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__40263){
var vec__40264 = p__40263;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__40264,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq40261){
...
var map__40272 = options;
var map__40272__$1 = (((((!((map__40272 == null))))?(((((map__40272.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__40272.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__40272):map__40272);
var include_ns_QMARK_ = cljs.core.get.call(null,map__40272__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__40272__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__40272__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__40272__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__40273 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__40273,(0),null);
var fn_name = cljs.core.nth.call(null,vec__40273,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__40273,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__40273,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__40273,(4),null);
var arity = cljs.core.nth.call(null,vec__40273,(5),null);
...
var o__38813__auto__ = f;
return (o__38813__auto__["getBasis"]).call(o__38813__auto__);
});
/**
...
}catch (e40277){var _e__38820__auto__ = e40277;
...
var G__40278 = (obj[cljs.core.first.call(null,path)]);
var G__40279 = cljs.core.rest.call(null,path);
obj = G__40278;
path = G__40279;
continue;
} else {
...
return (function (accum,p__40280){
var vec__40281 = p__40280;
var bit = cljs.core.nth.call(null,vec__40281,(0),null);
var protocol = cljs.core.nth.call(null,vec__40281,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__40284){
...
var selector = cljs.core.nth.call(null,vec__40285,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__40290,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__40290,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__40290,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__40288_SHARP_){
return (obj[cljs.core.first.call(null,p1__40288_SHARP_)]);
});})(name,sorted_matches,vec__40290,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1563208749127
