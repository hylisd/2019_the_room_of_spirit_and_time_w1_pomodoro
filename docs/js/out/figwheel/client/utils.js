...
return (new CustomEvent(event_name,(function (){var obj43420 = ({"detail":data});
return obj43420;
})()));
} else {
...
var f = (function (){var pred__43427 = cljs.core._EQ_;
var expr__43428 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__43427.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__43428))){
return ((function (pred__43427,expr__43428){
return (function (p1__43421_SHARP_){
return console.warn(p1__43421_SHARP_);
});
;})(pred__43427,expr__43428))
} else {
if(cljs.core.truth_(pred__43427.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__43428))){
return ((function (pred__43427,expr__43428){
return (function (p1__43422_SHARP_){
return console.debug(p1__43422_SHARP_);
});
;})(pred__43427,expr__43428))
} else {
if(cljs.core.truth_(pred__43427.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__43428))){
return ((function (pred__43427,expr__43428){
return (function (p1__43423_SHARP_){
return console.error(p1__43423_SHARP_);
});
;})(pred__43427,expr__43428))
} else {
return ((function (pred__43427,expr__43428){
return (function (p1__43424_SHARP_){
return console.log(p1__43424_SHARP_);
});
;})(pred__43427,expr__43428))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__43431){
var map__43432 = p__43431;
var map__43432__$1 = (((((!((map__43432 == null))))?(((((map__43432.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__43432.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__43432):map__43432);
var opts = map__43432__$1;
var eval_fn = cljs.core.get.call(null,map__43432__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__43434_SHARP_);
});})(new_def))
);
...
return (function (p__43435){
var vec__43436 = p__43435;
var ky = cljs.core.nth.call(null,vec__43436,(0),null);
var v = cljs.core.nth.call(null,vec__43436,(1),null);
...
//# sourceMappingURL=utils.js.map?rel=1562982106123
