...
var G__36701 = devtools.prefs.pref.call(null,v);
v = G__36701;
continue;
} else {
return v;
...
}catch (e36704){var _e__36424__auto__ = e36704;
return false;
}})();
...
}catch (e36708){var _e__36424__auto__ = e36708;
return false;
}})();
...
}catch (e36710){var _e__36424__auto__ = e36710;
return false;
}}
}
});
...
var vec__36712 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__36712,(0),null);
var name = cljs.core.nth.call(null,vec__36712,(1),null);
...
return cljs.core.some.call(null,(function (p1__36715_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__36715_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1562982100920
