...
var o36596 = temp__5733__auto__;
var temp__5733__auto____$1 = (o36596["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o36597 = temp__5733__auto____$1;
return (o36597["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__36417__auto__ = f;
return (o__36417__auto__["toString"]).call(o__36417__auto__);
} else {
return "";
}
...
try{var o__36417__auto___36600 = t;
(o__36417__auto___36600["cljs$lang$ctorPrWriter"]).call(o__36417__auto___36600,t,writer);
}catch (e36599){var __36601 = e36599;
}
...
var char_code = (function (){var o__36417__auto__ = (new String(char$));
return (o__36417__auto__["charCodeAt"]).call(o__36417__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__36417__auto__ = String;
return (o__36417__auto__["fromCharCode"]).call(o__36417__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__36602 = num_code;
switch (G__36602) {
case (1):
return (185);
...
var o__36417__auto__ = String;
return (o__36417__auto__["fromCharCode"]).call(o__36417__auto__,superscript_code);
});
/**
...
}catch (e36604){var _e__36424__auto__ = e36604;
return false;
}})())){
...
var vec__36605 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__36605,(0),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var o36608 = temp__5733__auto__;
var temp__5733__auto____$1 = (o36608["dependencies_"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o36609 = temp__5733__auto____$1;
return (o36609["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__36612){
var vec__36613 = p__36612;
var ns_detector = cljs.core.nth.call(null,vec__36613,(0),null);
...
var G__36619 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__36620 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__36619;
remaining_tokens = G__36620;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq36610){
var G__36611 = cljs.core.first.call(null,seq36610);
var seq36610__$1 = cljs.core.next.call(null,seq36610);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__36611,seq36610__$1);
});
...
var vec__36624 = cljs.core.split_with.call(null,(function (p1__36623_SHARP_){
return cljs.core.not_EQ_.call(null,p1__36623_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__36624,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__36624,(1),null);
...
var vec__36630 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__36630,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__36630,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__36633 = cljs.core.rest.call(null,remaining_tokens);
var G__36634 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__36633;
name_tokens = G__36634;
continue;
} else {
...
var vec__36637 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__36637,(0),null);
var arity = cljs.core.nth.call(null,vec__36637,(1),null);
var vec__36640 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__36640,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__36640,(1),null);
var vec__36643 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__36643,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__36643,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__36643,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__36643,(3),null);
...
var vec__36649 = result;
var munged_ns = cljs.core.nth.call(null,vec__36649,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__36649,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__36649,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__36649,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__36649,(4),null);
var arity = cljs.core.nth.call(null,vec__36649,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__36653 = temp__5733__auto__;
var munged_name = cljs.core.nth.call(null,vec__36653,(0),null);
var args = cljs.core.nth.call(null,vec__36653,(1),null);
var vec__36656 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__36656,(0),null);
var name = cljs.core.nth.call(null,vec__36656,(1),null);
...
var G__36659 = (arity + (1));
var G__36660 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__36661){
var vec__36662 = p__36661;
var arity = cljs.core.nth.call(null,vec__36662,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__36662,(1),null);
...
return cljs.core.get.call(null,arities,p1__36665_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__36666_SHARP_);
...
var args__4736__auto__ = [];
var len__4730__auto___36673 = arguments.length;
var i__4731__auto___36674 = (0);
while(true){
if((i__4731__auto___36674 < len__4730__auto___36673)){
args__4736__auto__.push((arguments[i__4731__auto___36674]));

var G__36675 = (i__4731__auto___36674 + (1));
i__4731__auto___36674 = G__36675;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__36669){
var vec__36670 = p__36669;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__36670,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq36667){
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__36678__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__36678__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__36678__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__36678__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__36679 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__36679,(0),null);
var fn_name = cljs.core.nth.call(null,vec__36679,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__36679,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__36679,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__36679,(4),null);
var arity = cljs.core.nth.call(null,vec__36679,(5),null);
...
var o__36417__auto__ = f;
return (o__36417__auto__["getBasis"]).call(o__36417__auto__);
});
/**
...
}catch (e36683){var _e__36424__auto__ = e36683;
...
var G__36684 = (obj[cljs.core.first.call(null,path)]);
var G__36685 = cljs.core.rest.call(null,path);
obj = G__36684;
path = G__36685;
continue;
} else {
...
return (function (accum,p__36686){
var vec__36687 = p__36686;
var bit = cljs.core.nth.call(null,vec__36687,(0),null);
var protocol = cljs.core.nth.call(null,vec__36687,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__36690){
var vec__36691 = p__36690;
var ns = cljs.core.nth.call(null,vec__36691,(0),null);
var name = cljs.core.nth.call(null,vec__36691,(1),null);
var selector = cljs.core.nth.call(null,vec__36691,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__36696,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__36696,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__36696,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__36694_SHARP_){
return (obj[cljs.core.first.call(null,p1__36694_SHARP_)]);
});})(name,sorted_matches,vec__36696,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1562982100851
