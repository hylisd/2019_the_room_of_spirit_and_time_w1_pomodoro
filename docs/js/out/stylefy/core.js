...
throw (new Error(["Assert failed: ",["Style should be a map or nil, got: ",cljs.core.pr_str.call(null,style)].join(''),"\n","(or (map? style) (nil? style))"].join('')));
}

if(((cljs.core.map_QMARK_.call(null,options)) || ((options == null)))){
} else {
throw (new Error(["Assert failed: ",["Options should be a map or nil, got: ",cljs.core.pr_str.call(null,options)].join(''),"\n","(or (map? options) (nil? options))"].join('')));
}
...
var i__4731__auto___47613 = (0);
while(true){
if((i__4731__auto___47613 < len__4730__auto___47612)){
args__4736__auto__.push((arguments[i__4731__auto___47613]));

var G__47614 = (i__4731__auto___47613 + (1));
i__4731__auto___47613 = G__47614;
continue;
} else {
}
break;
...
throw (new Error(["Assert failed: ",["Sub style should be referenced by keyword, got: ",cljs.core.pr_str.call(null,sub_styles)].join(''),"\n","(every? keyword? sub-styles)"].join('')));
}
...
/** @this {Function} */
stylefy.core.sub_style.cljs$lang$applyTo = (function (seq47610){
var G__47611 = cljs.core.first.call(null,seq47610);
var seq47610__$1 = cljs.core.next.call(null,seq47610);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__47611,seq47610__$1);
});
...
var args__4736__auto__ = [];
var len__4730__auto___47620 = arguments.length;
var i__4731__auto___47621 = (0);
while(true){
if((i__4731__auto___47621 < len__4730__auto___47620)){
args__4736__auto__.push((arguments[i__4731__auto___47621]));

var G__47622 = (i__4731__auto___47621 + (1));
i__4731__auto___47621 = G__47622;
continue;
} else {
}
break;
...
throw (new Error(["Assert failed: ",["Identifier should be string, got: ",cljs.core.pr_str.call(null,identifier)].join(''),"\n","(string? identifier)"].join('')));
}
...
/** @this {Function} */
stylefy.core.keyframes.cljs$lang$applyTo = (function (seq47618){
var G__47619 = cljs.core.first.call(null,seq47618);
var seq47618__$1 = cljs.core.next.call(null,seq47618);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__47619,seq47618__$1);
});
...
throw (new Error(["Assert failed: ",["Properties should be a map, got: ",cljs.core.pr_str.call(null,properties)].join(''),"\n","(map? properties)"].join('')));
}
...
throw (new Error(["Assert failed: ",["Tag name should be a string, got: ",cljs.core.pr_str.call(null,name)].join(''),"\n","(string? name)"].join('')));
}
...
throw (new Error(["Assert failed: ",["Name should be a string, got: ",cljs.core.pr_str.call(null,name)].join(''),"\n","(string? name)"].join('')));
}
...
throw (new Error(["Assert failed: ",["Styles should be seqable, got: ",cljs.core.pr_str.call(null,styles)].join(''),"\n","(seqable? styles)"].join('')));
}

if(cljs.core.every_QMARK_.call(null,cljs.core.map_QMARK_,cljs.core.remove.call(null,cljs.core.nil_QMARK_,styles))){
} else {
throw (new Error(["Assert failed: ",["Every style should be a map or nil, got: ",cljs.core.pr_str.call(null,styles)].join(''),"\n","(every? map? (remove nil? styles))"].join('')));
}
...
//# sourceMappingURL=core.js.map?rel=1562998564799
