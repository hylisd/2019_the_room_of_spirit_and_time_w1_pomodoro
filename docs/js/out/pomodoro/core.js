...
pomodoro.core.counter = reagent.core.atom.call(null,(1500));
}
...
if((typeof pomodoro !== 'undefined') && (typeof pomodoro.core !== 'undefined') && (typeof pomodoro.core.page !== 'undefined')){
} else {
pomodoro.core.page = reagent.core.atom.call(null,new cljs.core.Keyword(null,"main","main",-2117802661));
}
...
return pomodoro.core.render_component_to_app.call(null,cljs.core.deref.call(null,pomodoro.core.page).call(null,pomodoro.core.route));
});
pomodoro.core.init_router = (function pomodoro$core$init_router(){
return cljs.core.add_watch.call(null,pomodoro.core.page,new cljs.core.Keyword(null,"watcher","watcher",2145165251),(function (key,atom,old_state,new_state){
...
//# sourceMappingURL=core.js.map?rel=1563171236082
