...
if((i < len)){
var k = (ks[i]);
var G__38927 = cljs.core.assoc.call(null,m,cljs.core.keyword.call(null,k),(o[k]));
var G__38928 = (i + (1));
m = G__38927;
i = G__38928;
continue;
...
return ((cljs.core.fn_QMARK_.call(null,c)) && ((!(((function (){var G__38930 = c;
var G__38930__$1 = (((G__38930 == null))?null:G__38930.prototype);
if((G__38930__$1 == null)){
return null;
} else {
return (G__38930__$1["reagentRender"]);
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_.call(null,c)) && ((!(((function (){var G__38932 = c;
var G__38932__$1 = (((G__38932 == null))?null:G__38932.prototype);
if((G__38932__$1 == null)){
return null;
} else {
return (G__38932__$1["render"]);
}
})() == null)))));
});
...
return (function() { 
var G__38935__delegate = function (args){
return reagent.impl.component.as_element.call(null,cljs.core.apply.call(null,cljs.core.vector,res,args));
};
var G__38935 = function (var_args){
var args = null;
...
return G__38935__delegate.call(this,args);};
G__38935.cljs$lang$maxFixedArity = 0;
G__38935.cljs$lang$applyTo = (function (arglist__38937){
var args = cljs.core.seq(arglist__38937);
return G__38935__delegate(args);
});
...
var _STAR_current_component_STAR__orig_val__38939 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__38940 = c;
reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__38940;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__38939;
}});
...
return ((function (G__38941,G__38941__$1){
...
var c = this;
var G__38946_38948 = (c["cljsRatom"]);
if((G__38946_38948 == null)){
} else {
reagent.ratom.dispose_BANG_.call(null,G__38946_38948);
}
...
var renders_38950 = cljs.core.select_keys.call(null,fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383),new cljs.core.Keyword(null,"componentFunction","componentFunction",825866104)], null));
var render_fun_38951 = cljs.core.first.call(null,cljs.core.vals.call(null,renders_38950));
if((cljs.core.count.call(null,renders_38950) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count.call(null,renders_38950))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_.call(null,render_fun_38951)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.call(null,render_fun_38951)].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var name__$1 = (function (){var G__38949 = name;
switch (G__38949) {
case "":
...
var G__38953 = o;
(G__38953[cljs.core.name.call(null,k)] = v);
...
var name = (function (){var G__38954 = fiber;
var G__38954__$1 = (((G__38954 == null))?null:(G__38954["type"]));
if((G__38954__$1 == null)){
return null;
} else {
return (G__38954__$1["displayName"]);
}
})();
var parent = (function (){var G__38955 = fiber;
if((G__38955 == null)){
return null;
} else {
return (G__38955["return"]);
}
})();
var path = (function (){var G__38956 = parent;
var G__38956__$1 = (((G__38956 == null))?null:reagent.impl.component.fiber_component_path.call(null,G__38956));
if((G__38956__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__38956__$1)," > "].join('');
}
})();
...
var temp__5733__auto__ = (function (){var or__4131__auto__ = (function (){var G__38958 = c;
if((G__38958 == null)){
return null;
} else {
return (G__38958["_reactInternalFiber"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
...
return G__38959._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__4131__auto__ = (function (){var G__38961 = c;
if((G__38961 == null)){
return null;
} else {
return (G__38961["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
var or__4131__auto____$1 = (function (){var G__38963 = c;
if((G__38963 == null)){
return null;
} else {
return G__38963._reactInternalInstance;
}
})();
...
var elem = (function (){var or__4131__auto__ = (function (){var G__38965 = instance;
if((G__38965 == null)){
return null;
} else {
return (G__38965["_currentElement"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
var G__38966 = instance;
if((G__38966 == null)){
return null;
} else {
return G__38966._currentElement;
}
}
})();
var name = (function (){var G__38967 = elem;
var G__38967__$1 = (((G__38967 == null))?null:(G__38967["type"]));
if((G__38967__$1 == null)){
return null;
} else {
return (G__38967__$1["displayName"]);
}
})();
var owner = (function (){var or__4131__auto__ = (function (){var G__38969 = elem;
if((G__38969 == null)){
return null;
} else {
return (G__38969["_owner"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
...
return G__38970._owner;
}
}
})();
var path = (function (){var G__38971 = owner;
var G__38971__$1 = (((G__38971 == null))?null:reagent.impl.component.component_path.call(null,G__38971));
if((G__38971__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__38971__$1)," > "].join('');
}
})();
var res = [path,cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_.call(null,res)){
...
var G__38972 = c;
var G__38972__$1 = (((G__38972 == null))?null:G__38972.constructor);
if((G__38972__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name.call(null,G__38972__$1);
}
}
})();
...
//# sourceMappingURL=component.js.map?rel=1562982103143
