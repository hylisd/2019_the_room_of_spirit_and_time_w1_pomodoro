...
var G__38975 = o;
(G__38975[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
var G__38979 = o;
(G__38979[reagent.impl.template.cached_custom_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
if(cljs.core.ifn_QMARK_.call(null,x)){
return (function() { 
var G__38980__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
...
while (G__38981__i < G__38981__a.length) {G__38981__a[G__38981__i] = arguments[G__38981__i + 0]; ++G__38981__i;}
  args = new cljs.core.IndexedSeq(G__38981__a,0,null);
} 
return G__38980__delegate.call(this,args);};
G__38980.cljs$lang$maxFixedArity = 0;
G__38980.cljs$lang$applyTo = (function (arglist__38982){
var args = cljs.core.seq(arglist__38982);
return G__38980__delegate(args);
});
...
var G__38984 = props;
var G__38984__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__38984,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__38984);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__38984__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__38985){
...
var props = map__38986__$1;
var class$ = cljs.core.get.call(null,map__38986__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
if(cljs.core.coll_QMARK_.call(null,class$)){
return cljs.core.assoc.call(null,props,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.call(null," ",cljs.core.keep.call(null,((function (map__38986,map__38986__$1,props,class$){
return (function (c){
...
});})(map__38986,map__38986__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__38988){
...
var on_write = cljs.core.get.call(null,map__38989__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render.call(null,((function (node_value,map__38989,map__38989__$1,on_write){
return (function (){
return reagent.impl.template.input_component_set_value.call(null,component);
});})(node_value,map__38989,map__38989__$1,on_write))
);
} else {
...
var G__38992 = jsprops;
(G__38992["defaultValue"] = value);

(G__38992["onChange"] = ((function (G__38992,v,value,on_change){
return (function (p1__38991_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__38991_SHARP_);
});})(G__38992,v,value,on_change))
);
...
var vec__38995 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__38995,(0),null);
var id = cljs.core.nth.call(null,vec__38995,(1),null);
var class$ = cljs.core.nth.call(null,vec__38995,(2),null);
...
var jsprops = ({"argv": v});
var temp__5739__auto___38999 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5739__auto___38999 == null)){
} else {
var key_39000 = temp__5739__auto___38999;
(jsprops["key"] = key_39000);
}
...
var temp__5739__auto___39001 = reagent.impl.template.key_from_vec.call(null,argv);
if((temp__5739__auto___39001 == null)){
} else {
var key_39002 = temp__5739__auto___39001;
reagent.impl.template.oset.call(null,jsprops,"key",key_39002);
}
...
var G__39003 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__39003["name"] = c);
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq39007){
var G__39008 = cljs.core.first.call(null,seq39007);
var seq39007__$1 = cljs.core.next.call(null,seq39007);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__39008,seq39007__$1);
});
...
break;
default:
var G__39014 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
v = G__39014;
continue;
...
var n__4607__auto___39016 = a.length;
var i_39017 = (0);
while(true){
if((i_39017 < n__4607__auto___39016)){
(a[i_39017] = reagent.impl.template.as_element.call(null,(a[i_39017])));

var G__39018 = (i_39017 + (1));
i_39017 = G__39018;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__4607__auto___39019 = a.length;
var i_39020 = (0);
while(true){
if((i_39020 < n__4607__auto___39019)){
var val_39021 = (a[i_39020]);
if(((cljs.core.vector_QMARK_.call(null,val_39021)) && ((reagent.impl.template.key_from_vec.call(null,val_39021) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_39020] = reagent.impl.template.as_element.call(null,val_39021));

var G__39022 = (i_39020 + (1));
i_39020 = G__39022;
continue;
} else {
}
...
var ctx = ({});
var vec__39023 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__39023,(0),null);
var derefed = cljs.core.nth.call(null,vec__39023,(1),null);
...
var G__39026 = (cljs.core.count.call(null,argv) - first_child);
switch (G__39026) {
case (0):
...
break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv.call(null,((function (G__39026){
...
//# sourceMappingURL=template.js.map?rel=1562982103236
