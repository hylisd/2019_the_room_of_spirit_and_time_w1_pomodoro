 ...
 */
garden.compression.token_fn = (function garden$compression$token_fn(p__47276){
var vec__47277 = p__47276;
var tag = cljs.core.nth.call(null,vec__47277,(0),null);
var re = cljs.core.nth.call(null,vec__47277,(1),null);
return ((function (vec__47277,tag,re){
return (function (s){
...
var len__4730__auto___47282 = arguments.length;
var i__4731__auto___47283 = (0);
while(true){
if((i__4731__auto___47283 < len__4730__auto___47282)){
args__4736__auto__.push((arguments[i__4731__auto___47283]));

var G__47284 = (i__4731__auto___47283 + (1));
i__4731__auto___47283 = G__47284;
continue;
} else {
}
break;
...
return p1__47280_SHARP_.call(null,s);
});})(fs))
,fs);
});
;})(fs))
...
/** @this {Function} */
garden.compression.tokenizer.cljs$lang$applyTo = (function (seq47281){
var self__4718__auto__ = this;
return self__4718__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq47281));
});
...
var map__47285 = temp__5733__auto__;
var map__47285__$1 = (((((!((map__47285 == null))))?(((((map__47285.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__47285.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__47285):map__47285);
var tag = cljs.core.get.call(null,map__47285__$1,new cljs.core.Keyword(null,"tag","tag",-1290361223));
var chunk = cljs.core.get.call(null,map__47285__$1,new cljs.core.Keyword(null,"chunk","chunk",-1191159620));
var size = cljs.core.get.call(null,map__47285__$1,new cljs.core.Keyword(null,"size","size",1098693007));
var G__47289 = cljs.core.subs.call(null,s1,size);
var G__47290 = [s2,cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__47288 = tag;
var G__47288__$1 = (((G__47288 instanceof cljs.core.Keyword))?G__47288.fqn:null);
switch (G__47288__$1) {
case "string":
return chunk;
...
//# sourceMappingURL=compression.js.map?rel=1562998564317
