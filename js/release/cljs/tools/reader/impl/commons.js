...
var G__28285 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
ch = G__28285;
continue;
} else {
return ch;
...
var vec__28286 = cljs.core.re_find(pattern,s);
var match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28286,(0),null);
return (match === s);
});
...
/** @this {Function} */
cljs.tools.reader.impl.commons.read_comment.cljs$lang$applyTo = (function (seq28289){
...
return (function() { 
var G__28294__delegate = function (rdr,_){
...
var G__28294 = function (rdr,var_args){
var _ = null;
if (arguments.length > 1) {
var G__28295__i = 0, G__28295__a = new Array(arguments.length -  1);
while (G__28295__i < G__28295__a.length) {G__28295__a[G__28295__i] = arguments[G__28295__i + 1]; ++G__28295__i;}
  _ = new cljs.core.IndexedSeq(G__28295__a,0,null);
} 
return G__28294__delegate.call(this,rdr,_);};
G__28294.cljs$lang$maxFixedArity = 1;
G__28294.cljs$lang$applyTo = (function (arglist__28296){
var rdr = cljs.core.first(arglist__28296);
var _ = cljs.core.rest(arglist__28296);
return G__28294__delegate(rdr,_);
});
