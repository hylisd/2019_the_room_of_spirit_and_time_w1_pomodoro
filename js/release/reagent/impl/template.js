...
var temp__5739__auto__ = reagent.impl.template.cache_get(reagent.impl.template.prop_name_cache,cljs.core.name(k));
if((temp__5739__auto__ == null)){
return (reagent.impl.template.prop_name_cache[cljs.core.name(k)] = reagent.impl.util.dash_to_camel(k));
} else {
var k_SINGLEQUOTE_ = temp__5739__auto__;
...
var G__26319 = o;
(G__26319[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
while (G__26321__i < G__26321__a.length) {G__26321__a[G__26321__i] = arguments[G__26321__i + 0]; ++G__26321__i;}
  args = new cljs.core.IndexedSeq(G__26321__a,0,null);
} 
...
if(reagent.impl.template.named_QMARK_(k)){
var temp__5739__auto__ = reagent.impl.template.cache_get(reagent.impl.template.custom_prop_name_cache,cljs.core.name(k));
if((temp__5739__auto__ == null)){
...
var G__26323 = o;
(G__26323[reagent.impl.template.cached_custom_prop_name(k)] = reagent.impl.template.convert_prop_value(v));
...
while (G__26325__i < G__26325__a.length) {G__26325__a[G__26325__i] = arguments[G__26325__i + 0]; ++G__26325__i;}
  args = new cljs.core.IndexedSeq(G__26325__a,0,null);
} 
...
var G__26328 = props;
var G__26328__$1 = (((((!((id == null)))) && ((cljs.core.cst$kw$id.cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__26328,cljs.core.cst$kw$id,id):G__26328);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__26328__$1,cljs.core.cst$kw$class,(function (){var old_class = cljs.core.cst$kw$class.cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__26329){
...
var props = map__26330__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26330__$1,cljs.core.cst$kw$class);
if(cljs.core.coll_QMARK_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(props,cljs.core.cst$kw$class,clojure.string.join.cljs$core$IFn$_invoke$arity$2(" ",cljs.core.keep.cljs$core$IFn$_invoke$arity$2(((function (map__26330,map__26330__$1,props,class$){
return (function (c){
...
});})(map__26330,map__26330__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__26332){
var map__26333 = p__26332;
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26333__$1,cljs.core.cst$kw$on_DASH_write);
...
return reagent.impl.batching.do_after_render(((function (node_value,map__26333,map__26333__$1,on_write){
return (function (){
...
});})(node_value,map__26333,map__26333__$1,on_write))
);
} else {
...
var G__26336 = jsprops;
(G__26336["defaultValue"] = value);

(G__26336["onChange"] = ((function (G__26336,v,value,on_change){
return (function (p1__26335_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__26335_SHARP_);
});})(G__26336,v,value,on_change))
);
...
var vec__26339 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26339,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26339,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26339,(2),null);
...
var temp__5739__auto__ = reagent.impl.template.get_key(cljs.core.meta(v));
if((temp__5739__auto__ == null)){
return reagent.impl.template.get_key(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(v,(1),null));
} else {
var k = temp__5739__auto__;
return k;
}
});
...
var jsprops = ({"argv": v});
var temp__5741__auto___26343 = reagent.impl.template.key_from_vec(v);
if((temp__5741__auto___26343 == null)){
} else {
var key_26344 = temp__5741__auto___26343;
(jsprops["key"] = key_26344);
}
...
var temp__5741__auto___26345 = reagent.impl.template.key_from_vec(argv);
if((temp__5741__auto___26345 == null)){
} else {
var key_26346 = temp__5741__auto___26345;
reagent.impl.template.oset(jsprops,"key",key_26346);
}
...
var G__26347 = reagent.impl.template.__GT_NativeWrapper();
(G__26347["name"] = c);
...
var temp__5739__auto__ = reagent.impl.template.cache_get(reagent.impl.template.tag_name_cache,x);
if((temp__5739__auto__ == null)){
...
var G__26348 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__26348) : reagent.impl.template.as_element.call(null,G__26348));
} else {
...
var len__4730__auto___26354 = arguments.length;
var i__4731__auto___26355 = (0);
while(true){
if((i__4731__auto___26355 < len__4730__auto___26354)){
args__4736__auto__.push((arguments[i__4731__auto___26355]));

var G__26356 = (i__4731__auto___26355 + (1));
i__4731__auto___26355 = G__26356;
continue;
} else {
}
break;
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq26352){
var G__26353 = cljs.core.first(seq26352);
var seq26352__$1 = cljs.core.next(seq26352);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__26353,seq26352__$1);
});
...
break;
default:
var G__26359 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__26359;
continue;
...
var n__4607__auto___26361 = a.length;
var i_26362 = (0);
while(true){
if((i_26362 < n__4607__auto___26361)){
(a[i_26362] = reagent.impl.template.as_element((a[i_26362])));
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4607__auto___26364 = a.length;
var i_26365 = (0);
while(true){
if((i_26365 < n__4607__auto___26364)){
var val_26366 = (a[i_26365]);
if(((cljs.core.vector_QMARK_(val_26366)) && ((reagent.impl.template.key_from_vec(val_26366) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_26365] = reagent.impl.template.as_element(val_26366));
...
var ctx = ({});
var vec__26368 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26368,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26368,(1),null);
...
var G__26371 = (cljs.core.count(argv) - first_child);
switch (G__26371) {
case (0):
...
case (1):
var G__26372 = comp;
var G__26373 = jsprops;
var G__26374 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return (reagent.impl.template.global$module$react.createElement.cljs$core$IFn$_invoke$arity$3 ? reagent.impl.template.global$module$react.createElement.cljs$core$IFn$_invoke$arity$3(G__26372,G__26373,G__26374) : reagent.impl.template.global$module$react.createElement.call(null,G__26372,G__26373,G__26374));

break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv(((function (G__26371){
