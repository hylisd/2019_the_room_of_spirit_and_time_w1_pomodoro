...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__49764),pomodoro$todo_list$menu_list_$_iter__49761.call(null,cljs.core.chunk_rest.call(null,s__49762__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__49764),null);
}
} else {
var item = cljs.core.first.call(null,s__49762__$2);
return cljs.core.cons.call(null,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"li","li",723558921),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"key","key",-1516042587),new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(item),new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"font-size","font-size",-1847940346),"36px"], null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"i.material-icons","i.material-icons",740058269),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"font-size","font-size",-1847940346),"36px"], null)], null),new cljs.core.Keyword(null,"icon","icon",1679606541).cljs$core$IFn$_invoke$arity$1(item)], null),new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(item)], null),pomodoro$todo_list$menu_list_$_iter__49761.call(null,cljs.core.rest.call(null,s__49762__$2)));
}
} else {
return null;
}
...
}),new cljs.core.Keyword(null,"on-save","on-save",1618176266),(function (p1__49766_SHARP_){
return cljs.core.swap_BANG_.call(null,pomodoro.core.todo_list,cljs.core.conj,p1__49766_SHARP_);
})], null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),"TO-DO",new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"ul","ul",-1349521403),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"list-style-type","list-style-type",-1703248598),"none",new cljs.core.Keyword(null,"padding-left","padding-left",-1180879053),"0",new cljs.core.Keyword(null,"margin","margin",-995903681),"0 0"], null)], null),(function (){var iter__4523__auto__ = (function pomodoro$todo_list$middle_part_$_iter__49770(s__49771){
return (new cljs.core.LazySeq(null,(function (){
var s__49771__$1 = s__49771;
while(true){
var temp__5735__auto__ = cljs.core.seq.call(null,s__49771__$1);
if(temp__5735__auto__){
var s__49771__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__49771__$2)){
var c__4521__auto__ = cljs.core.chunk_first.call(null,s__49771__$2);
var size__4522__auto__ = cljs.core.count.call(null,c__4521__auto__);
var b__49773 = cljs.core.chunk_buffer.call(null,size__4522__auto__);
if((function (){var i__49772 = (0);
while(true){
if((i__49772 < size__4522__auto__)){
var todo = cljs.core._nth.call(null,c__4521__auto__,i__49772);
cljs.core.chunk_append.call(null,b__49773,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"li","li",723558921),new cljs.core.PersistentArrayMap(null, 6, [new cljs.core.Keyword(null,"key","key",-1516042587),todo,new cljs.core.Keyword(null,"draggable","draggable",1676206163),true,new cljs.core.Keyword(null,"on-drag-start","on-drag-start",-47712205),((function (i__49772,todo,c__4521__auto__,size__4522__auto__,b__49773,s__49771__$2,temp__5735__auto__){
return (function (){
return console.log("drag start");
});})(i__49772,todo,c__4521__auto__,size__4522__auto__,b__49773,s__49771__$2,temp__5735__auto__))
,new cljs.core.Keyword(null,"on-drag-enter","on-drag-enter",-1692112235),((function (i__49772,todo,c__4521__auto__,size__4522__auto__,b__49773,s__49771__$2,temp__5735__auto__){
return (function (p1__49767_SHARP_){
return console.log("drag enter: ",p1__49767_SHARP_);
});})(i__49772,todo,c__4521__auto__,size__4522__auto__,b__49773,s__49771__$2,temp__5735__auto__))
,new cljs.core.Keyword(null,"on-drag-over","on-drag-over",-93410408),((function (i__49772,todo,c__4521__auto__,size__4522__auto__,b__49773,s__49771__$2,temp__5735__auto__){
return (function (p1__49768_SHARP_){
return console.log("drag over: ",p1__49768_SHARP_);
});})(i__49772,todo,c__4521__auto__,size__4522__auto__,b__49773,s__49771__$2,temp__5735__auto__))
,new cljs.core.Keyword(null,"on-drag-leave","on-drag-leave",-373180078),((function (i__49772,todo,c__4521__auto__,size__4522__auto__,b__49773,s__49771__$2,temp__5735__auto__){
return (function (p1__49769_SHARP_){
return console.log("drap leave : ",p1__49769_SHARP_);
});})(i__49772,todo,c__4521__auto__,size__4522__auto__,b__49773,s__49771__$2,temp__5735__auto__))
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__49773),pomodoro$todo_list$middle_part_$_iter__49770.call(null,cljs.core.chunk_rest.call(null,s__49771__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__49773),null);
}
} else {
var todo = cljs.core.first.call(null,s__49771__$2);
return cljs.core.cons.call(null,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"li","li",723558921),new cljs.core.PersistentArrayMap(null, 6, [new cljs.core.Keyword(null,"key","key",-1516042587),todo,new cljs.core.Keyword(null,"draggable","draggable",1676206163),true,new cljs.core.Keyword(null,"on-drag-start","on-drag-start",-47712205),((function (todo,s__49771__$2,temp__5735__auto__){
return (function (){
return console.log("drag start");
});})(todo,s__49771__$2,temp__5735__auto__))
,new cljs.core.Keyword(null,"on-drag-enter","on-drag-enter",-1692112235),((function (todo,s__49771__$2,temp__5735__auto__){
return (function (p1__49767_SHARP_){
return console.log("drag enter: ",p1__49767_SHARP_);
});})(todo,s__49771__$2,temp__5735__auto__))
,new cljs.core.Keyword(null,"on-drag-over","on-drag-over",-93410408),((function (todo,s__49771__$2,temp__5735__auto__){
return (function (p1__49768_SHARP_){
return console.log("drag over: ",p1__49768_SHARP_);
});})(todo,s__49771__$2,temp__5735__auto__))
,new cljs.core.Keyword(null,"on-drag-leave","on-drag-leave",-373180078),((function (todo,s__49771__$2,temp__5735__auto__){
return (function (p1__49769_SHARP_){
return console.log("drap leave : ",p1__49769_SHARP_);
});})(todo,s__49771__$2,temp__5735__auto__))
], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"i.material-icons","i.material-icons",740058269),"radio_button_unchecked"], null),todo,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"i.material-icons","i.material-icons",740058269),"play_circle_outline"], null)], null),pomodoro$todo_list$middle_part_$_iter__49770.call(null,cljs.core.rest.call(null,s__49771__$2)));
}
} else {
return null;
}
...
//# sourceMappingURL=todo_list.js.map?rel=1563201978440
