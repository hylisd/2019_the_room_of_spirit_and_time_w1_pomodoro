...
return (new CustomEvent(event_name,(function (){var obj46151 = ({"detail":data});
return obj46151;
})()));
} else {
...
var f = (function (){var pred__46158 = cljs.core._EQ_;
var expr__46159 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__46158.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__46159))){
return ((function (pred__46158,expr__46159){
return (function (p1__46152_SHARP_){
return console.warn(p1__46152_SHARP_);
});
;})(pred__46158,expr__46159))
} else {
if(cljs.core.truth_(pred__46158.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__46159))){
return ((function (pred__46158,expr__46159){
return (function (p1__46153_SHARP_){
return console.debug(p1__46153_SHARP_);
});
;})(pred__46158,expr__46159))
} else {
if(cljs.core.truth_(pred__46158.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__46159))){
return ((function (pred__46158,expr__46159){
return (function (p1__46154_SHARP_){
return console.error(p1__46154_SHARP_);
});
;})(pred__46158,expr__46159))
} else {
return ((function (pred__46158,expr__46159){
return (function (p1__46155_SHARP_){
return console.log(p1__46155_SHARP_);
});
;})(pred__46158,expr__46159))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__46162){
var map__46163 = p__46162;
var map__46163__$1 = (((((!((map__46163 == null))))?(((((map__46163.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__46163.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__46163):map__46163);
var opts = map__46163__$1;
var eval_fn = cljs.core.get.call(null,map__46163__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__46165_SHARP_);
});})(new_def))
);
...
return (function (p__46166){
var vec__46167 = p__46166;
var ky = cljs.core.nth.call(null,vec__46167,(0),null);
var v = cljs.core.nth.call(null,vec__46167,(1),null);
...
//# sourceMappingURL=utils.js.map?rel=1563183878113
