...
var G__36674 = devtools.prefs.pref.call(null,v);
v = G__36674;
continue;
} else {
return v;
...
}catch (e36677){var _e__35657__auto__ = e36677;
return false;
}})();
...
}catch (e36681){var _e__35657__auto__ = e36681;
return false;
}})();
...
}catch (e36683){var _e__35657__auto__ = e36683;
return false;
}}
}
});
...
var vec__36685 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__36685,(0),null);
var name = cljs.core.nth.call(null,vec__36685,(1),null);
...
return cljs.core.some.call(null,(function (p1__36688_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__36688_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1563183870893
