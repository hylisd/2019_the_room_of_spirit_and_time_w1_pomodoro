...
var o36569 = temp__5733__auto__;
var temp__5733__auto____$1 = (o36569["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o36570 = temp__5733__auto____$1;
return (o36570["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__35650__auto__ = f;
return (o__35650__auto__["toString"]).call(o__35650__auto__);
} else {
return "";
}
}catch (e36571){var _ = e36571;
return "";
}});
...
try{var o__35650__auto___36573 = t;
(o__35650__auto___36573["cljs$lang$ctorPrWriter"]).call(o__35650__auto___36573,t,writer);
}catch (e36572){var __36574 = e36572;
}
...
var char_code = (function (){var o__35650__auto__ = (new String(char$));
return (o__35650__auto__["charCodeAt"]).call(o__35650__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__35650__auto__ = String;
return (o__35650__auto__["fromCharCode"]).call(o__35650__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__36575 = num_code;
switch (G__36575) {
case (1):
return (185);
...
var o__35650__auto__ = String;
return (o__35650__auto__["fromCharCode"]).call(o__35650__auto__,superscript_code);
});
/**
...
}catch (e36577){var _e__35657__auto__ = e36577;
return false;
}})())){
...
var vec__36578 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__36578,(0),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var o36581 = temp__5733__auto__;
var temp__5733__auto____$1 = (o36581["dependencies_"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o36582 = temp__5733__auto____$1;
return (o36582["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4730__auto___36589 = arguments.length;
var i__4731__auto___36590 = (0);
while(true){
if((i__4731__auto___36590 < len__4730__auto___36589)){
args__4736__auto__.push((arguments[i__4731__auto___36590]));

var G__36591 = (i__4731__auto___36590 + (1));
i__4731__auto___36590 = G__36591;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__36585){
var vec__36586 = p__36585;
var ns_detector = cljs.core.nth.call(null,vec__36586,(0),null);
...
var G__36592 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__36593 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__36592;
remaining_tokens = G__36593;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq36583){
var G__36584 = cljs.core.first.call(null,seq36583);
var seq36583__$1 = cljs.core.next.call(null,seq36583);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__36584,seq36583__$1);
});
...
var vec__36597 = cljs.core.split_with.call(null,(function (p1__36596_SHARP_){
return cljs.core.not_EQ_.call(null,p1__36596_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__36597,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__36597,(1),null);
...
var vec__36603 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__36603,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__36603,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__36606 = cljs.core.rest.call(null,remaining_tokens);
var G__36607 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__36606;
name_tokens = G__36607;
continue;
} else {
...
var vec__36610 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__36610,(0),null);
var arity = cljs.core.nth.call(null,vec__36610,(1),null);
var vec__36613 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__36613,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__36613,(1),null);
var vec__36616 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__36616,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__36616,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__36616,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__36616,(3),null);
...
var vec__36622 = result;
var munged_ns = cljs.core.nth.call(null,vec__36622,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__36622,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__36622,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__36622,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__36622,(4),null);
var arity = cljs.core.nth.call(null,vec__36622,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__36626 = temp__5733__auto__;
var munged_name = cljs.core.nth.call(null,vec__36626,(0),null);
var args = cljs.core.nth.call(null,vec__36626,(1),null);
var vec__36629 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__36629,(0),null);
var name = cljs.core.nth.call(null,vec__36629,(1),null);
...
var G__36632 = (arity + (1));
var G__36633 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__36634){
var vec__36635 = p__36634;
var arity = cljs.core.nth.call(null,vec__36635,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__36635,(1),null);
...
return cljs.core.get.call(null,arities,p1__36638_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__36639_SHARP_);
...
var args__4736__auto__ = [];
var len__4730__auto___36646 = arguments.length;
var i__4731__auto___36647 = (0);
while(true){
if((i__4731__auto___36647 < len__4730__auto___36646)){
args__4736__auto__.push((arguments[i__4731__auto___36647]));

var G__36648 = (i__4731__auto___36647 + (1));
i__4731__auto___36647 = G__36648;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__36642){
var vec__36643 = p__36642;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__36643,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq36640){
var G__36641 = cljs.core.first.call(null,seq36640);
var seq36640__$1 = cljs.core.next.call(null,seq36640);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__36641,seq36640__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__36651__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__36651__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__36651__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__36651__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__36652 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__36652,(0),null);
var fn_name = cljs.core.nth.call(null,vec__36652,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__36652,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__36652,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__36652,(4),null);
var arity = cljs.core.nth.call(null,vec__36652,(5),null);
...
var o__35650__auto__ = f;
return (o__35650__auto__["getBasis"]).call(o__35650__auto__);
});
/**
...
}catch (e36656){var _e__35657__auto__ = e36656;
...
var G__36657 = (obj[cljs.core.first.call(null,path)]);
var G__36658 = cljs.core.rest.call(null,path);
obj = G__36657;
path = G__36658;
continue;
} else {
...
return (function (accum,p__36659){
var vec__36660 = p__36659;
var bit = cljs.core.nth.call(null,vec__36660,(0),null);
var protocol = cljs.core.nth.call(null,vec__36660,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__36663){
var vec__36664 = p__36663;
var ns = cljs.core.nth.call(null,vec__36664,(0),null);
var name = cljs.core.nth.call(null,vec__36664,(1),null);
var selector = cljs.core.nth.call(null,vec__36664,(2),null);
...
return (function (p__36668){
var vec__36669 = p__36668;
var munged_name = cljs.core.nth.call(null,vec__36669,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__36669,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__36669,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__36667_SHARP_){
return (obj[cljs.core.first.call(null,p1__36667_SHARP_)]);
});})(name,sorted_matches,vec__36669,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1563183870815
