...
var G__38992 = o;
(G__38992[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__38993__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
var G__38993 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__38994__i = 0, G__38994__a = new Array(arguments.length -  0);
while (G__38994__i < G__38994__a.length) {G__38994__a[G__38994__i] = arguments[G__38994__i + 0]; ++G__38994__i;}
  args = new cljs.core.IndexedSeq(G__38994__a,0,null);
} 
return G__38993__delegate.call(this,args);};
G__38993.cljs$lang$maxFixedArity = 0;
G__38993.cljs$lang$applyTo = (function (arglist__38995){
var args = cljs.core.seq(arglist__38995);
return G__38993__delegate(args);
});
...
var G__38996 = o;
(G__38996[reagent.impl.template.cached_custom_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
var G__39001 = props;
var G__39001__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__39001,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__39001);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__39001__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__39002){
var map__39003 = p__39002;
var map__39003__$1 = (((((!((map__39003 == null))))?(((((map__39003.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__39003.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__39003):map__39003);
var props = map__39003__$1;
...
return cljs.core.assoc.call(null,props,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.call(null," ",cljs.core.keep.call(null,((function (map__39003,map__39003__$1,props,class$){
return (function (c){
...
});})(map__39003,map__39003__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__39005){
...
var on_write = cljs.core.get.call(null,map__39006__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render.call(null,((function (node_value,map__39006,map__39006__$1,on_write){
return (function (){
return reagent.impl.template.input_component_set_value.call(null,component);
});})(node_value,map__39006,map__39006__$1,on_write))
);
} else {
...
var G__39009 = jsprops;
(G__39009["defaultValue"] = value);

(G__39009["onChange"] = ((function (G__39009,v,value,on_change){
return (function (p1__39008_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__39008_SHARP_);
});})(G__39009,v,value,on_change))
);
...
var vec__39012 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__39012,(0),null);
var id = cljs.core.nth.call(null,vec__39012,(1),null);
var class$ = cljs.core.nth.call(null,vec__39012,(2),null);
...
var jsprops = ({"argv": v});
var temp__5739__auto___39016 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5739__auto___39016 == null)){
} else {
var key_39017 = temp__5739__auto___39016;
(jsprops["key"] = key_39017);
}
...
var temp__5739__auto___39018 = reagent.impl.template.key_from_vec.call(null,argv);
if((temp__5739__auto___39018 == null)){
} else {
var key_39019 = temp__5739__auto___39018;
reagent.impl.template.oset.call(null,jsprops,"key",key_39019);
}
...
var G__39020 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__39020["name"] = c);
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq39024){
...
break;
default:
var G__39031 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
v = G__39031;
continue;
...
var n__4607__auto___39033 = a.length;
var i_39034 = (0);
while(true){
if((i_39034 < n__4607__auto___39033)){
(a[i_39034] = reagent.impl.template.as_element.call(null,(a[i_39034])));

var G__39035 = (i_39034 + (1));
i_39034 = G__39035;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__4607__auto___39036 = a.length;
var i_39037 = (0);
while(true){
if((i_39037 < n__4607__auto___39036)){
var val_39038 = (a[i_39037]);
if(((cljs.core.vector_QMARK_.call(null,val_39038)) && ((reagent.impl.template.key_from_vec.call(null,val_39038) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_39037] = reagent.impl.template.as_element.call(null,val_39038));

var G__39039 = (i_39037 + (1));
i_39037 = G__39039;
continue;
} else {
}
...
var ctx = ({});
var vec__39040 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__39040,(0),null);
var derefed = cljs.core.nth.call(null,vec__39040,(1),null);
...
var G__39043 = (cljs.core.count.call(null,argv) - first_child);
switch (G__39043) {
case (0):
...
break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv.call(null,((function (G__39043){
...
//# sourceMappingURL=template.js.map?rel=1563183873384
