...
if((i < len)){
var k = (ks[i]);
var G__38944 = cljs.core.assoc.call(null,m,cljs.core.keyword.call(null,k),(o[k]));
var G__38945 = (i + (1));
m = G__38944;
i = G__38945;
continue;
...
return ((cljs.core.fn_QMARK_.call(null,c)) && ((!(((function (){var G__38947 = c;
var G__38947__$1 = (((G__38947 == null))?null:G__38947.prototype);
if((G__38947__$1 == null)){
return null;
} else {
return (G__38947__$1["reagentRender"]);
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_.call(null,c)) && ((!(((function (){var G__38949 = c;
var G__38949__$1 = (((G__38949 == null))?null:G__38949.prototype);
if((G__38949__$1 == null)){
return null;
} else {
return (G__38949__$1["render"]);
}
})() == null)))));
});
...
return (function() { 
var G__38952__delegate = function (args){
...
while (G__38953__i < G__38953__a.length) {G__38953__a[G__38953__i] = arguments[G__38953__i + 0]; ++G__38953__i;}
  args = new cljs.core.IndexedSeq(G__38953__a,0,null);
} 
return G__38952__delegate.call(this,args);};
G__38952.cljs$lang$maxFixedArity = 0;
G__38952.cljs$lang$applyTo = (function (arglist__38954){
var args = cljs.core.seq(arglist__38954);
return G__38952__delegate(args);
});
...
var _STAR_current_component_STAR__orig_val__38956 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__38957 = c;
reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__38957;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__38956;
}});
...
var G__38958 = key;
var G__38958__$1 = (((G__38958 instanceof cljs.core.Keyword))?G__38958.fqn:null);
switch (G__38958__$1) {
...
return ((function (G__38958,G__38958__$1){
...
var c = this;
var G__38963_38965 = (c["cljsRatom"]);
if((G__38963_38965 == null)){
} else {
reagent.ratom.dispose_BANG_.call(null,G__38963_38965);
}
...
var renders_38967 = cljs.core.select_keys.call(null,fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383),new cljs.core.Keyword(null,"componentFunction","componentFunction",825866104)], null));
var render_fun_38968 = cljs.core.first.call(null,cljs.core.vals.call(null,renders_38967));
if((cljs.core.count.call(null,renders_38967) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count.call(null,renders_38967))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_.call(null,render_fun_38968)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.call(null,render_fun_38968)].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var name__$1 = (function (){var G__38966 = name;
switch (G__38966) {
case "":
...
var G__38970 = o;
(G__38970[cljs.core.name.call(null,k)] = v);
...
var name = (function (){var G__38971 = fiber;
var G__38971__$1 = (((G__38971 == null))?null:(G__38971["type"]));
if((G__38971__$1 == null)){
return null;
} else {
return (G__38971__$1["displayName"]);
}
})();
var parent = (function (){var G__38972 = fiber;
if((G__38972 == null)){
return null;
} else {
return (G__38972["return"]);
}
})();
var path = (function (){var G__38973 = parent;
var G__38973__$1 = (((G__38973 == null))?null:reagent.impl.component.fiber_component_path.call(null,G__38973));
if((G__38973__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__38973__$1)," > "].join('');
}
})();
...
var temp__5733__auto__ = (function (){var or__4131__auto__ = (function (){var G__38975 = c;
if((G__38975 == null)){
return null;
} else {
return (G__38975["_reactInternalFiber"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
...
return G__38976._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__4131__auto__ = (function (){var G__38978 = c;
if((G__38978 == null)){
return null;
} else {
return (G__38978["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
var or__4131__auto____$1 = (function (){var G__38980 = c;
if((G__38980 == null)){
return null;
} else {
return G__38980._reactInternalInstance;
}
})();
...
var elem = (function (){var or__4131__auto__ = (function (){var G__38982 = instance;
if((G__38982 == null)){
return null;
} else {
return (G__38982["_currentElement"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
var G__38983 = instance;
if((G__38983 == null)){
return null;
} else {
return G__38983._currentElement;
}
}
})();
var name = (function (){var G__38984 = elem;
var G__38984__$1 = (((G__38984 == null))?null:(G__38984["type"]));
if((G__38984__$1 == null)){
return null;
} else {
return (G__38984__$1["displayName"]);
}
})();
var owner = (function (){var or__4131__auto__ = (function (){var G__38986 = elem;
if((G__38986 == null)){
return null;
} else {
return (G__38986["_owner"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
...
return G__38987._owner;
}
}
})();
var path = (function (){var G__38988 = owner;
var G__38988__$1 = (((G__38988 == null))?null:reagent.impl.component.component_path.call(null,G__38988));
if((G__38988__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__38988__$1)," > "].join('');
}
})();
var res = [path,cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_.call(null,res)){
...
var G__38989 = c;
var G__38989__$1 = (((G__38989 == null))?null:G__38989.constructor);
if((G__38989__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name.call(null,G__38989__$1);
}
}
})();
...
//# sourceMappingURL=component.js.map?rel=1563183873281
